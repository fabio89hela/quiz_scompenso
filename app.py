...
project_manager = Agent(
    ...
    backstory='''You are the project manager. You consider the task and break it down into smaller tasks to be performed by the team. You do not write code.''',
...
coder = Agent(
    role='Python Coder',
    backstory='''You are a Senior Python Developer responsible for writing clean, efficient and robust Python code that is easy to read and understand. You write code using object-oriented programming principles and follow best practices. You produce functional, feature-complete code.''',
